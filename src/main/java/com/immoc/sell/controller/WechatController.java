...
//@RestController // 将结果转换为json对象，不会对重定向操作进行重定向，故这个地方用controller
@Controller
...
public class WechatController {
    ...
    public String authorize(@RequestParam("returnUrl") String returnUrl) {
        ...
        // 2.调用方法
        String url = "http://maruimin.natapp4.cc/sell/wechat/userInfo";
    ...
    public String qrAuthorize(@RequestParam("returnUrl") String returnUrl) {
        String url = "http://maruimin/natapp1.cc/sell/wechat/qrUserInfo";
